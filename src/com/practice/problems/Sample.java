...
public class Sample {
	...
	public static void main(String[] args) {
		...
		/*
		 * map.put(words.get(0), new Value(8, words.get(1))); map.put(words.get(1), new
		 * Value(10, words.get(2))); map.put(words.get(2), new Value(24, words.get(3)));
		 * map.put(words.get(3), new Value(300, words.get(4))); map.put(words.get(4),
		 * new Value(0, words.get(0)));
		 */
...
class Value {
	...
	public String toString() {
		return "Value{" + "value=" + value + ", relation='" + relation + '\'' + '}';
	}
}
